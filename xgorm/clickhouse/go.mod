module github.com/xiaoshicae/xtow/xgorm/clickhouse

go 1.25.0

require (
	github.com/xiaoshicae/xtow/xgorm v0.0.0
...
require (
	...
	github.com/xiaoshicae/xtow v0.0.0 // indirect
	github.com/xiaoshicae/xtow/xmetric v0.0.0 // indirect
